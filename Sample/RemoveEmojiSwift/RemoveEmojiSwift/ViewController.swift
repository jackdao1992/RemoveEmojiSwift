...
//        print(stringemoji)
        ...
        let stringText = "🇦🆆 🅢 🄗 🄄 🀖 𝌺 𝄡 𝄞 𝂩 𝀭 QWERTYUIOP{}|\":LKJHYGTFRDESAZXCVB NM<>?   🌄  🌅  🌆  🌇  🌈  🌉  🌊  🌋  🌌  🌍  🌎  🌏  🌐  🌑  🌒  🌓  🌔  🌕  🌖  🌗  🌘  🌙  🌚  🌛  🌜  🌝  🌞  🌟  🌠  🌡  🌢  🌣  🌤  🌥  🌦  🌧  🌨  🌩  🌪  🌫  🌬  🌭  🌮  🌯  🌰  🌱  🌲  🌳  🌴  🌵  🌶  🌷  🌸  🌹  🌺  🌻  🌼  🌽  🌾  🌿  🍀  🍁  🍂  🍃  🍄  🍅  🍆  🍇  🍈  🍉  🍊  🍋  🍌  🍍  🍎  qtyuiop[]\\asdfghjkl;'zxcvbnm,./ 🅷 `1234567890-=~!@#$%^&*()_+ CHINE-有一天，我们开发什么 FRENCH-un jour, nous développons rien   😇  😈  😉  😊  😋  😌  😍  😎  😏  😐  😑  😒  😓  😔  😕  😖  😗  😘  😙 🚊 🚎 JAPANESE-ある日、私たちは何を開発 🔕 📡 💘 🐾  KOREAN-일일 우리는 아무것도 개발  🄧 🎬 🄨 arabic-يوم واحد ونحن نطور شيئا "// + stringemoji
